####################################################################################################################################
#
#                              MODIS - Extract band values at points within the area of interest
#
####################################################################################################################################

#DESCRIPTION: The function Extract_BandValuesAtPoints() can be used to iterate through all images of a MODIS image collection. 
