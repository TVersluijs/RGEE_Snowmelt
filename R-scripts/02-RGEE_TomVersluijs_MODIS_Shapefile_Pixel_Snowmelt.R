...
###########################################################################################################################################################################
  ...
  #        write.csv(ZAC_Paths, paste0(here(), "/Output/MODIS/02_Shapefile_Pixel_Snowmelt/", data_ID, "_ChickMovement_Snowmelt_doy_Buffer", Buffer_radius_m, ".csv"), row.names = FALSE)
  # 
  ...
  #          theme_tom()
  #
  #          ggsave(plot=p1, paste0(here(), "/Output/MODIS/02_Shapefile_Pixel_Snowmelt/", data_ID, "_MovementPaths_Snowmelt_doy_Grid_Buffer", Buffer_radius_m, ".pdf"), width=10, height = 8)
  # 
  ...
  #          theme_tom()
  #
  #          ggsave(plot=p2, paste0(here(), "/Output/MODIS/02_Shapefile_Pixel_Snowmelt/", data_ID, "_GrowthParameter_Mean_Snowmelt_doy_Buffer", Buffer_radius_m, ".pdf"), width=10, height = 8)
  # 
...
#          new_scale_color()
#          }
#      ggsave(plot=p3, paste0(here(), "/Output/MODIS/02_Shapefile_Pixel_Snowmelt/", data_ID, "_Chick_Movement_Snowmelt.pdf"), width=13 , height=12 , units="in")
