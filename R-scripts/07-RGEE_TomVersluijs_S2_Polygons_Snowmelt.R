         ...
         tryCatch({print(p1)},
            ...
            warning = function(w){
              if(grepl("st_point_on_surface", w$message)){
                suppressWarnings(ggsave(plot=p1, paste0(here(), "/Output/S2/07_Polygons_Snowmelt/", timestamp, "_",paste0(area_name, "_S2"), "_Polygons.pdf"), width=10, height=8))
    ...
    #(11) Create a timeseries GIF of unmasked RGB and NDSI images for aoi_Shapefile
      ...
      if(gif_output==TRUE){
        ...
        f_img_col_to_gif(img_col=s2_col,  #image collection
                         ...
                         gif_text_col="#FFFFFF",
                         output_fldr=paste0(root_fldr, "/Output/S2/07_Polygons_Snowmelt/"),
                         file_name="GIF_RGB")
...
#The End     
 ...
 {cat("\n") ; cat("\n")
  ...
  cat("\n")
  print(paste0("-Generated data and plots can be found at ", here(), "/Output/S2/07_Polygons_Snowmelt/"))
  print("--------------------------------------------------------------------------------------------------------------------------")
  cat("\n")}     
